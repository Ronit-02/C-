...
void add_node(class node *first)
    {
    char a[100];
    ...
    first->next=(class node*)malloc(sizeof(class node));
    first->prev=first;
    first=first->next;
...
void add_node_file(class node *first,string a)
    {
    while(first->next!=NULL)
    {
        first=first->next;
...
void del_node(class node *first)
{
...
void printlist(class node *first)
{
    cout<<"\nPlaylist Name- ";
    while(first->next!=NULL)
    {
...
void count_nodes(class node *first)
{
    int i=0;
    while (first->next!=NULL)
    {
...
class node  *del_pos(class node *pointer, int pos)
{

           class node *n1,*prev1,*temp;
           prev1= ( class node *)malloc(sizeof(node));
           temp= (class node *)malloc(sizeof(node));
           int i=0;
...
void addplaylist(class node *start)
{
    fstream f1;
    string line;
...
void del_search(class node *start)
{
    char song[100];
    printlist(start);
...
void deletemenu(class node *start)
{
    int c;
...
main()
{
    int choice,loc;
    char song[100];
    class node *start,*hold;
    start=(class node *) malloc(sizeof(class node));
